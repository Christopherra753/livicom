        ...
        <div className='grid h-full items-center'>
          ...
          <div className='flex lg:flex-row flex-col justify-between gap-8 pt-12'>
            <div className='w-full lg:w-5/12 flex flex-col justify-center'>
              ...
              <p className='font-medium text-base leading-6 text-shop-200 '>Nuestra historia es una travesía de pasión y dedicación. Fundada en 2000, Livicom ha crecido desde un modesto taller hasta una destacada mueblería. Hemos evolucionado, manteniendo siempre nuestro compromiso con la calidad y el diseño.</p>
            </div>
